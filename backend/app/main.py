...
# Configure Gemini — force stable v1 endpoint so text-embedding-004 is reachable
# (google-generativeai <0.8 defaults to v1beta where this model is NOT available)
if GEMINI_API_KEY:
    genai.configure(
